...
abstract class AppPadding {
  //height padding
  static double padding8h = 8.0.h;
  static double padding14h = 14.0.h;
  static double padding20h = 20.0.h;
  static double padding30h = 30.0.h;
  static double padding40h = 40.0.h;
  static double padding80h = 80.0.h;

  //width padding
  static double padding8w = 8.0.w;
  static double padding14w = 14.0.w;
  static double padding24w = 24.0.w;
}
